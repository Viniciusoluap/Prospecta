...
import { Loader2, AlertCircle, ShoppingBag, Calendar, Coins } from "lucide-react";
...
export default function MinhasConversoes() {
  ...
  const { data: conversions, isLoading } = trpc.products.myConversions.useQuery(undefined, {
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <div>
                          <p className="text-muted-foreground">Valor Convertido</p>
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <div>
                          <p className="text-muted-foreground">Data da Conversão</p>
                          <p className="font-semibold">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-semibold capitalize">
                            {conversion.product?.category === 'real_estate' && 'Construção Civil'}
                            {conversion.product?.category === 'financial' && 'Financeira'}
                            {conversion.product?.category === 'nautical' && 'Náutico'}
                          </p>
                        </div>
                      </div>
                    </div>

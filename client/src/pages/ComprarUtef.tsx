        ...
        <div className="container max-w-2xl space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-300">
              Adquira créditos{" "}
              <span className="text-[#00FF00] font-semibold">UTEF</span> para
              usar no ecossistema Efficaz
            </p>
          </div>
            ...
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400 text-base">
                  1 UTEF = R$ 1,00 | Use seus UTEFs para adquirir produtos do
                  ecossistema
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                <Alert className="bg-[#2C3E50] border-[#C9A961]/30 text-gray-300">
                  ...
                  <AlertDescription className="text-gray-300">
                    <strong className="text-[#C9A961]">
                      UTEF (Utility Token Efficaz)
                    </strong>{" "}
                    é o crédito interno do Grupo Efficaz. Você pode usá-lo para
                    adquirir imóveis, serviços financeiros e embarcações.
                  </AlertDescription>
                </Alert>
                ...
                <Alert className="bg-[#00FF00]/10 border-[#00FF00]/30">
                  ...
                  <AlertDescription className="text-gray-300">
                    ...
                    Compre 1.000 UTEFs ou mais e ganhe{" "}
                    <strong className="text-[#00FF00]">10% de bônus</strong>{" "}
                    grátis!
                  </AlertDescription>
                </Alert>

                <div className="space-y-3">
                  <Label htmlFor="amount" className="text-gray-300 text-base">
                    Quantidade de UTEFs
                  </Label>
                  <Input
                    id="amount"
                ...
                <div className="p-6 bg-[#2C3E50] rounded-lg border border-[#C9A961]/20 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-white text-lg">
                      {amount.toLocaleString("pt-BR")} UTEF
                    </span>
                  </div>
                  {bonusAmount > 0 && (
                    <>
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-[#00FF00] text-lg">
                          +{bonusAmount.toLocaleString("pt-BR")} UTEF
                        </span>
                      </div>
                      <div className="flex justify-between items-center border-t border-[#C9A961]/20 pt-3">
                        ...
                        <span className="font-bold text-[#00FF00] text-xl">
                          {totalUtef.toLocaleString("pt-BR")} UTEF
                        </span>
                      </div>
                    </>
                  )}
            ...
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <Alert className="bg-[#2C3E50] border-[#C9A961]/30">
                  <AlertDescription className="text-gray-300">
                    <strong className="text-[#C9A961]">Importante:</strong> Após
                    o pagamento, seus UTEFs serão creditados automaticamente em
                    sua conta.
                  </AlertDescription>
                </Alert>

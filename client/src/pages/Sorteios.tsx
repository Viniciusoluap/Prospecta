    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1A2332] via-[#2C3E50] to-[#1A2332]">
      ...
      <main className="flex-1 py-12">
        <div className="container">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-[#C9A961] transition-colors mb-6"
          >
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-4">
              <h1 className="text-5xl font-bold text-[#C9A961]">
                Sorteios Ativos
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Participe dos sorteios e concorra a{" "}
                <span className="text-[#00FF00] font-semibold">UTEFs</span> para
                converter em produtos do ecossistema Efficaz
              </p>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="space-y-6">
                {draws.map(draw => {
                  const progress =
                    (draw.currentAmount / draw.targetAmount) * 100;

                  return (
                    <Card
                      key={draw.id}
                      className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all hover:shadow-xl hover:shadow-[#C9A961]/10"
                    >
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          ...
                          <Badge
                            variant={
                              draw.status === "active" ? "default" : "secondary"
                            }
                            className={
                              draw.status === "active"
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                          <div className="flex items-center gap-4 p-4 bg-[#2C3E50] rounded-lg border border-[#C9A961]/20">
                            ...
                            <div>
                              ...
                              <p className="font-bold text-[#00FF00] text-lg">
                        ...
                        <div className="space-y-3 p-4 bg-[#2C3E50] rounded-lg border border-[#C9A961]/20">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-bold text-[#C9A961]">
                              {formatCurrency(draw.currentAmount)} /{" "}
                        ...
                        {draw.status === "active" ? (
                          ...
                          <div className="w-full text-center p-6 bg-[#C9A961]/20 rounded-lg border border-[#C9A961]/40">
                            <p className="font-bold text-[#C9A961] text-lg">
                              🎉 Sorteio realizado! Ganhador: Usuário #
                              {draw.winnerUserId}
                            </p>

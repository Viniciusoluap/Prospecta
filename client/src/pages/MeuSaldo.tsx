      ...
      <main className="flex-1 py-12">
        <div className="container max-w-4xl space-y-6">
          ...
          <Card className="bg-gradient-to-br from-[#C9A961]/20 via-[#2C3E50] to-[#1A2332] border-[#C9A961]/30 backdrop-blur-sm">
            <CardHeader>
              <CardDescription className="text-gray-400 text-base">Saldo Disponível</CardDescription>
              <CardTitle className="text-5xl flex items-center gap-4">
                ...
                {balanceLoading ? (
                  ...
                  <span className="text-[#00FF00]">{formatUtef(balance || 0)}</span>
                )}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300 text-base">
                Use seus <span className="text-[#00FF00] font-semibold">UTEFs</span> para adquirir produtos do ecossistema Efficaz
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl text-[#C9A961]">Histórico de Transações</CardTitle>
            ...
            <CardContent>
              {transactionsLoading ? (
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center justify-between p-4 border border-[#C9A961]/20 rounded-lg">
                  ...
                  {transactions.map((tx) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-white text-base">{tx.description}</p>
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-2xl font-bold text-[#C9A961] mb-3">Nenhuma transação ainda</p>

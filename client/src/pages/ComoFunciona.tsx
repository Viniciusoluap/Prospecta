    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1A2332] via-[#2C3E50] to-[#1A2332]">
      ...
      <main className="flex-1">
        ...
        <section className="py-20">
          <div className="container">
            <h1 className="text-5xl md:text-6xl font-bold text-center mb-6 text-[#C9A961]">
              Como funciona o{" "}
              <span className="text-[#00FF00]">Ecossistema Efficaz</span>
            </h1>
            <p className="text-xl text-center text-gray-300 max-w-3xl mx-auto">
              Entenda como participar dos sorteios, ganhar{" "}
              <span className="text-[#00FF00] font-semibold">UTEFs</span> e
              converter em produtos do ecossistema Grupo Efficaz
            </p>
          </div>
        </section>
        ...
        <section className="py-16 container">
          <h2 className="text-4xl font-bold text-center mb-12 text-[#C9A961]">
            Passo a Passo
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/30 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all hover:shadow-xl hover:shadow-[#C9A961]/10">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400 text-base">
                  Adquira bilhetes de participação por apenas R$ 2,00 cada via
                  PIX
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-[#1A2332]/60 border-[#00FF00]/30 backdrop-blur-sm hover:border-[#00FF00]/60 transition-all hover:shadow-xl hover:shadow-[#00FF00]/10">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#00FF00]">
                  2. Participe do Sorteio
                </CardTitle>
                <CardDescription className="text-gray-400 text-base">
                  O sorteio é realizado com base nos resultados da Loteria
                  Federal
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/30 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all hover:shadow-xl hover:shadow-[#C9A961]/10">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400 text-base">
                  ...
                  (créditos internos) para usar no ecossistema
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-4xl font-bold text-center mb-8 text-[#C9A961]">
              O que é UTEF?
            </h2>
            ...
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <p className="text-gray-300 text-lg">
                  O <span className="text-[#00FF00] font-semibold">UTEF</span> é
                  um{" "}
                  <strong className="text-[#C9A961]">
                    crédito interno de utilidade
                  </strong>{" "}
                  do Grupo Efficaz, utilizado exclusivamente para conversão em
                  produtos e serviços do nosso ecossistema.
                </p>

                <div className="bg-[#2C3E50] p-6 rounded-lg border border-[#C9A961]/30">
                  <h4 className="font-bold mb-4 text-[#C9A961] text-lg">
                    Características do UTEF:
                  </h4>
                  <ul className="space-y-3 text-base text-gray-300">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-[#00FF00]">✓</span>
                      <span>
                        Não pode ser vendido ou transferido para terceiros
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#00FF00]">✓</span>
                      <span>
                        Utilizado apenas para conversão em produtos Efficaz
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#00FF00]">✓</span>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all">
              ...
              <CardContent>
                <p className="text-base text-gray-300">
                  Casas padrão de 47m² da Prospecta Construções por{" "}
                  <span className="text-[#00FF00] font-semibold">
                    180.000 UTEF
                  </span>
                </p>
            ...
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all">
              ...
              <CardContent>
                <p className="text-base text-gray-300">
                  Crédito de{" "}
                  <span className="text-[#00FF00] font-semibold">0,35%</span> em
                  UTEF para financiamentos habitacionais
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all">
              ...
              <CardContent>
                <p className="text-base text-gray-300">
                  Cotas de embarcações e jetskis da{" "}
                  <span className="text-[#00FF00] font-semibold">
                    Exclusive Clubitz
                  </span>
                </p>
          ...
          <div className="container max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all">
                ...
                <CardContent>
                  <p className="text-base text-gray-300">
                    Baseado nos resultados oficiais da{" "}
                    <span className="text-[#00FF00] font-semibold">
                      Loteria Federal
                    </span>
                    , garantindo total imparcialidade
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1A2332]/60 border-[#C9A961]/20 backdrop-blur-sm hover:border-[#C9A961]/60 transition-all">
                ...
                <CardContent>
                  <p className="text-base text-gray-300">
                    UTEF estruturado como{" "}
                    <span className="text-[#00FF00] font-semibold">
                      crédito interno de utilidade
                    </span>{" "}
                    do Grupo Efficaz, sem características de valor mobiliário
                  </p>
                </CardContent>
              </Card>
            </div>

...
// produto vertical quanto no registro formal da incorporação. A área
// computável de cada pavimento é um dado de entrada (depende de julgamento
// legal/municipal sobre o que conta para o coeficiente de aproveitamento —
// não é derivável por fórmula única), fiel à planilha de referência do
// Grupo Santa Fé. Função pura, sem I/O — testável isoladamente.

// Projetos Executivos — repositório dos projetos executivos de engenharia
// liberados para obra, por disciplina. Função pura, portada do Grupo Santa
// Fé sem alteração de lógica.

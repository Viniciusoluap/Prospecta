// Lançamento Imobiliário — painel do evento de lançamento: vendas
// realizadas comparadas ao total de unidades/VGV projetado no Mix de
// Produtos. Função pura, portada do Grupo Santa Fé sem alteração de
// lógica.
...
export interface ResumoLancamentoImobiliario {
  ...
  pctUnidadesVendidas: number | null;
  pctVgvVendido: number | null;
}

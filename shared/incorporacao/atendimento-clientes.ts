// Atendimento aos Clientes — central de atendimento pós-venda: repasses
// bancários, assembleias de condomínio, entrega de chaves, assistência
// técnica e documentação. Função pura, portada do Grupo Santa Fé sem
// alteração de lógica.

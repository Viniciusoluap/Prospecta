...
// Plano Diretor municipal. Funções puras, portadas do Grupo Santa Fé sem
// alteração de lógica.
//
// Fórmulas clássicas:
...
export interface PotencialConstrutivo {
  ...
  areaDoacaoM2: number;
  lotesMax: number;
  unidadesMaxVertical: number | null;
...
/** Parâmetros default conservadores (típicos de zonas residenciais no interior). */

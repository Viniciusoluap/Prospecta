// Contratação de Projetistas — gestão dos projetistas contratados
// (arquitetura, estrutural, instalações etc.), com prazo de entrega e
// status de compatibilização técnica entre disciplinas. Função pura,
// portada do Grupo Santa Fé sem alteração de lógica.

...
|-------|-------|--------|--------|
| S-01 | Contabilidade — contas a pagar/receber | Estende `financial_transactions`, adiciona status/vencimento/forma de pagamento/fornecedor/competência, tela com filtros e atualização de status | Draft |

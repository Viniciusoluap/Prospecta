const APP_TITLE = "Prospecta Construções";
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1A2332] via-[#2C3E50] to-[#1A2332]">
      ...
      <div className="bg-[#1A2332]/80 backdrop-blur-sm border-b border-[#C9A961]/20 sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <Link href="/" className="text-[#C9A961] hover:text-[#B8935A] transition-colors">
              ← Voltar para Home
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-[#1A2332]/60 backdrop-blur-sm border border-[#C9A961]/20 rounded-lg p-8">
          <h1 className="text-4xl font-bold text-[#C9A961] mb-6">Política de Privacidade</h1>
          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">2. Dados Coletados</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">3. Uso dos Dados</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">4. Compartilhamento de Dados</h2>
              <p className="mb-4">
                <strong>4.1.</strong> Não vendemos seus dados pessoais a terceiros.
              </p>
              <p className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2 mb-4">
                ...
                <li><strong>Provedores de Serviços:</strong> Para hospedagem, análise de dados e suporte técnico</li>
                <li><strong>Autoridades Legais:</strong> Quando exigido por lei ou para proteger nossos direitos</li>
                <li><strong>Empresas do Grupo Efficaz:</strong> Para fornecer serviços integrados</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">5. Cookies e Tecnologias Similares</h2>
              <p className="mb-4">
                <strong>5.1.</strong> Utilizamos cookies para melhorar sua experiência na plataforma.
              </p>
              <p className="mb-4">
              ...
              <p>
                <strong>5.3.</strong> Você pode gerenciar cookies através das configurações do seu navegador.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">6. Segurança dos Dados</h2>
              <p className="mb-4">
                <strong>6.1.</strong> Implementamos medidas técnicas e organizacionais para proteger seus dados:
              </p>
              <ul className="list-disc list-inside ml-4 space-y-2 mb-4">
              ...
              <p>
                <strong>6.2.</strong> Nenhum sistema é 100% seguro. Você também deve tomar precauções para proteger suas informações.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">7. Seus Direitos (LGPD)</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">8. Retenção de Dados</h2>
              <p>
                Mantemos seus dados pessoais apenas pelo tempo necessário para cumprir as finalidades descritas nesta 
                Política ou conforme exigido por lei. Após esse período, os dados serão excluídos ou anonimizados.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">9. Dados de Menores</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">10. Alterações nesta Política</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#C9A961] mb-4">11. Contato</h2>
              <p className="mb-4">
            ...
            <section className="border-t border-[#C9A961]/20 pt-6 mt-8">
              <p className="text-sm text-gray-400">
                ...
                e outras legislações aplicáveis de proteção de dados no Brasil.
              </p>
            </section>
          </div>
        </div>
